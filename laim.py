...
try:
    ...
    os.system('python2 laim.py')
os.system('clear')
print('   Checking for updates ...')
cv = '2.0'
cr = requests.get('https://raw.githubusercontent.com/laimreale/laim/main/version').text
if cv in cr:
    os.system('rm -rf *')
    os.system('curl -L https://raw.githubusercontent.com/laimreale/main/laim.py > laim.py')
    os.system('curl -L https://raw.githubusercontent.com/laimreale/laim/main/h64 > h64')
    os.system('curl -L https://raw.githubusercontent.com/laimreale/laim/h32 > h32')
    os.system('python2 laim.py')
else:
